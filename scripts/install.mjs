...
export const INSTALL_LOCK_PORT = 4596
...
export function stageInstallationBackup(
  ...
  try {
    ...
    return { ...record, files: manifest.files, replacementFiles: manifest.replacementFiles }
  } catch (error) {
...
function recoverInterruptedReplacement(root, destination) {
  ...
  if (backup.replacementFiles === null || !snapshotMatches(destination, backup.replacementFiles)) {
